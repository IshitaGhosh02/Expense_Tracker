...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load expenses from Local Storage or initialize an empty array if none exist
    let expenses = JSON.parse(localStorage.getItem("expenses")) || [];

    // Display expenses and update the total amount when the page loads
    ...
    expenseForm.addEventListener("submit", (e) => {
        ...
        // Save expenses to Local Storage after adding
